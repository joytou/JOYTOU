...
function searchbulletinboard(){
 $.ajax({
    url: 'https://api.github.com/repos/{{ site.github_username }}/{{ site.github_repo }}/issues?labels={{ site.github_label }}&per_page=1&page='+pagenum,
    dataType: 'json',
    success: function(data) {
if(data[0].user.login=='{{ site.github_username }}'){
